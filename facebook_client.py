...
def get_valid_instagram_image(caption: str, user_image_url: str = None) -> str:
    """
    Retourne une URL d'image valide et accessible publiquement par l'API Instagram.
    Si aucune URL valide n'est fournie, utilise une image publique Pollinations par défaut.
    """
    if user_image_url and user_image_url.startswith("http"):
        try:
            ...
            logger.warning("L'URL d'image fournie n'est pas accessible. Utilisation de l'image par défaut...")

    logger.info("Utilisation de l'image Instagram par défaut : https://pollinations.ai/og-image.png")
    return "https://pollinations.ai/og-image.png"
...
class FacebookClient:
    ...
    def post_to_instagram(self, message: str, image_url: str = "") -> bool:
        ...
        try:
            ...
            logger.debug("Publication du post Instagram : POST %s", publish_url)
    ...
    def post_to_threads(self, message: str, image_url: str = "") -> bool:
        ...
        try:
            ...
            logger.debug("Publication du container Threads : POST %s", publish_url)
