...
def check_config() -> None:
    ...
    print("=" * 60)
    print(f"META_ACCESS_TOKEN   : {'✅ défini (' + config.META_ACCESS_TOKEN[:25] + '...)' if config.META_ACCESS_TOKEN else '❌ MANQUANT'}")
...
def main() -> None:
    ...
    if not config.META_ACCESS_TOKEN:
        print("\n❌ META_ACCESS_TOKEN manquant — impossible de continuer.")
        return
